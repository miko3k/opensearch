...
import org.deletethis.search.parser.SearchEngineFactory;
...
public class Main {
    public static void main(String[] args) throws IOException, SuggestionParseException, EngineParseException {
        ...
        SearchEngine searchEngine = SearchEngineFactory.loadSearchEngine(is);

        System.out.println("Id: " + searchEngine.getIdentifier());
